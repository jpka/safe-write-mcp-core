...
**Result:** `checkRequestProvenance` runs on every route including read-only ones; the approve/reject POSTs additionally require `application/json` (browsers preflight it, blocking form-based CSRF) and cap the body at 64 KiB.

---

## 2026-08-13 — Reject-as-tombstone: a rejected plan stays PLAN_REJECTED forever
